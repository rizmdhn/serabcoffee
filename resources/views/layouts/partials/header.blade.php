    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg navbar-light bg-light " style="z-index: 10 ;font-size: 1.5rem;">
            ...
            @if (!Request::cookie('table_number'))

            @else
            <p class="float-right align-baseline m-0 pr-4"> Table {{ Request::cookie('table_number') }}</p>
            <a href="{{ route('cart.list') }}" class="float-right pr-5 text-black-50">
                ...
                {{ Cart::session(Request::cookie('table_number'))->getTotalQuantity()}}
            </a>
