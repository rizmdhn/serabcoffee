    ...
    <div class="row pt-4">
        <div class="col-3">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link active" id="v-pills-Coffee-tab" href="/product/coffee">Coffee</a>
                <a class="nav-link" id="v-pills-nonCoffee-tab" href="/product/non-coffee">Non-Coffee</a>
                <a class="nav-link" id="v-pills-MainCourse-tab" href="/product/main-course">Main Course</a>
            </div>
        </div>
        <div class="col-9">
            <div class="row p-2">
                                ...
                                <div class="box-up">
                                    ...
                                    <div class="img-info">
                                        <div class="info-inner">
                                            ...
                                            <span class="p-company">{{ $product->category_name->category_name }}</span>
                                        </div>
                                    </div>
                                </div>
